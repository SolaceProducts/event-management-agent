...
import com.solace.maas.ep.event.management.agent.plugin.solaceconfig.processor.semp.ReplicatedTopicApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        ReplicatedTopicApi apiInstance = new ReplicatedTopicApi(defaultClient);
