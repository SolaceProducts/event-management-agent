...
/**
 * API tests for AuthenticationOauthProfileApi
 */
@Ignore
public class AuthenticationOauthProfileApiTest {

    private final AuthenticationOauthProfileApi api = new AuthenticationOauthProfileApi();
