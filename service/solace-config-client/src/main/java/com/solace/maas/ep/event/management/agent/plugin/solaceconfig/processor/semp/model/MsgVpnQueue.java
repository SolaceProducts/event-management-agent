 ...
 */
@JsonPropertyOrder({
  MsgVpnQueue.JSON_PROPERTY_ACCESS_TYPE,
  MsgVpnQueue.JSON_PROPERTY_CONSUMER_ACK_PROPAGATION_ENABLED,
  MsgVpnQueue.JSON_PROPERTY_DEAD_MSG_QUEUE,
  MsgVpnQueue.JSON_PROPERTY_DELIVERY_COUNT_ENABLED,
  MsgVpnQueue.JSON_PROPERTY_DELIVERY_DELAY,
  MsgVpnQueue.JSON_PROPERTY_EGRESS_ENABLED,
  MsgVpnQueue.JSON_PROPERTY_EVENT_BIND_COUNT_THRESHOLD,
  ...
  MsgVpnQueue.JSON_PROPERTY_MAX_BIND_COUNT,
  MsgVpnQueue.JSON_PROPERTY_MAX_DELIVERED_UNACKED_MSGS_PER_FLOW,
  MsgVpnQueue.JSON_PROPERTY_MAX_MSG_SIZE,
  MsgVpnQueue.JSON_PROPERTY_MAX_MSG_SPOOL_USAGE,
  MsgVpnQueue.JSON_PROPERTY_MAX_REDELIVERY_COUNT,
  MsgVpnQueue.JSON_PROPERTY_MAX_TTL,
  MsgVpnQueue.JSON_PROPERTY_MSG_VPN_NAME,
  MsgVpnQueue.JSON_PROPERTY_OWNER,
  MsgVpnQueue.JSON_PROPERTY_PERMISSION,
  MsgVpnQueue.JSON_PROPERTY_QUEUE_NAME,
  MsgVpnQueue.JSON_PROPERTY_REDELIVERY_ENABLED,
  MsgVpnQueue.JSON_PROPERTY_REJECT_LOW_PRIORITY_MSG_ENABLED,
  MsgVpnQueue.JSON_PROPERTY_REJECT_LOW_PRIORITY_MSG_LIMIT,
  MsgVpnQueue.JSON_PROPERTY_REJECT_MSG_TO_SENDER_ON_DISCARD_BEHAVIOR,
  MsgVpnQueue.JSON_PROPERTY_RESPECT_MSG_PRIORITY_ENABLED,
  MsgVpnQueue.JSON_PROPERTY_RESPECT_TTL_ENABLED
})
...
public class MsgVpnQueue {
  ...
  **/
  ...
  public MsgVpnQueue deliveryCountEnabled(Boolean deliveryCountEnabled) {
  ...
  **/
  ...
  public MsgVpnQueue deliveryDelay(Long deliveryDelay) {
  ...
  **/
  ...
  public MsgVpnQueue redeliveryEnabled(Boolean redeliveryEnabled) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessType, msgVpnQueue.accessType) &&
        ...
        Objects.equals(this.deliveryCountEnabled, msgVpnQueue.deliveryCountEnabled) &&
        Objects.equals(this.deliveryDelay, msgVpnQueue.deliveryDelay) &&
        ...
        Objects.equals(this.redeliveryEnabled, msgVpnQueue.redeliveryEnabled) &&
