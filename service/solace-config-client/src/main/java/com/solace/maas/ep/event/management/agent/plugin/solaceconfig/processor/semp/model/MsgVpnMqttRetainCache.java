 ...
 */
@JsonPropertyOrder({
  MsgVpnMqttRetainCache.JSON_PROPERTY_CACHE_NAME,
  MsgVpnMqttRetainCache.JSON_PROPERTY_ENABLED,
  MsgVpnMqttRetainCache.JSON_PROPERTY_MSG_LIFETIME,
  MsgVpnMqttRetainCache.JSON_PROPERTY_MSG_VPN_NAME
})
