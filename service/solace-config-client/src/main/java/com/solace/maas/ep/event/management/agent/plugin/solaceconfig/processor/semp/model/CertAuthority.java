 ...
 */
@JsonPropertyOrder({
  CertAuthority.JSON_PROPERTY_CERT_AUTHORITY_NAME,
  CertAuthority.JSON_PROPERTY_CERT_CONTENT,
  CertAuthority.JSON_PROPERTY_CRL_DAY_LIST,
  CertAuthority.JSON_PROPERTY_CRL_TIME_LIST,
  CertAuthority.JSON_PROPERTY_CRL_URL,
  CertAuthority.JSON_PROPERTY_OCSP_NON_RESPONDER_CERT_ENABLED,
  CertAuthority.JSON_PROPERTY_OCSP_OVERRIDE_URL,
  CertAuthority.JSON_PROPERTY_OCSP_TIMEOUT,
  CertAuthority.JSON_PROPERTY_REVOCATION_CHECK_ENABLED
})
