 ...
 */
@JsonPropertyOrder({
  VirtualHostname.JSON_PROPERTY_ENABLED,
  VirtualHostname.JSON_PROPERTY_MSG_VPN_NAME,
  VirtualHostname.JSON_PROPERTY_VIRTUAL_HOSTNAME
})
...
public class VirtualHostname {
  ...
  public static final String JSON_PROPERTY_VIRTUAL_HOSTNAME = "virtualHostname";
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_VIRTUAL_HOSTNAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
