 ...
 */
@JsonPropertyOrder({
  MsgVpnReplicatedTopic.JSON_PROPERTY_MSG_VPN_NAME,
...
public class MsgVpnReplicatedTopic {
  ...
  public static final String JSON_PROPERTY_REPLICATED_TOPIC = "replicatedTopic";
  private String replicatedTopic;
  ...
  public static final String JSON_PROPERTY_REPLICATION_MODE = "replicationMode";
  private ReplicationModeEnum replicationMode;

  public MsgVpnReplicatedTopic() {
  }
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_REPLICATED_TOPIC)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_REPLICATION_MODE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
