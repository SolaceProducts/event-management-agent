 ...
 */
@JsonPropertyOrder({
  MsgVpnJndiQueue.JSON_PROPERTY_MSG_VPN_NAME,
  MsgVpnJndiQueue.JSON_PROPERTY_PHYSICAL_NAME,
  MsgVpnJndiQueue.JSON_PROPERTY_QUEUE_NAME
})
...
public class MsgVpnJndiQueue {
  ...
  public static final String JSON_PROPERTY_PHYSICAL_NAME = "physicalName";
  private String physicalName;

  public static final String JSON_PROPERTY_QUEUE_NAME = "queueName";
  private String queueName;

  public MsgVpnJndiQueue() {
  }
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_PHYSICAL_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
