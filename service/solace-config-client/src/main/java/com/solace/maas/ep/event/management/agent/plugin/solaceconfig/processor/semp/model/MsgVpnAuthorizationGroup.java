 ...
 */
@JsonPropertyOrder({
  MsgVpnAuthorizationGroup.JSON_PROPERTY_ACL_PROFILE_NAME,
  MsgVpnAuthorizationGroup.JSON_PROPERTY_AUTHORIZATION_GROUP_NAME,
  MsgVpnAuthorizationGroup.JSON_PROPERTY_CLIENT_PROFILE_NAME,
  MsgVpnAuthorizationGroup.JSON_PROPERTY_ENABLED,
  MsgVpnAuthorizationGroup.JSON_PROPERTY_MSG_VPN_NAME,
...
public class MsgVpnAuthorizationGroup {
  ...
  public static final String JSON_PROPERTY_AUTHORIZATION_GROUP_NAME = "authorizationGroupName";
  ...
  public static final String JSON_PROPERTY_ORDER_AFTER_AUTHORIZATION_GROUP_NAME = "orderAfterAuthorizationGroupName";
  private String orderAfterAuthorizationGroupName;

  public static final String JSON_PROPERTY_ORDER_BEFORE_AUTHORIZATION_GROUP_NAME = "orderBeforeAuthorizationGroupName";
  private String orderBeforeAuthorizationGroupName;

  public MsgVpnAuthorizationGroup() {
  }
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_AUTHORIZATION_GROUP_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ORDER_BEFORE_AUTHORIZATION_GROUP_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
