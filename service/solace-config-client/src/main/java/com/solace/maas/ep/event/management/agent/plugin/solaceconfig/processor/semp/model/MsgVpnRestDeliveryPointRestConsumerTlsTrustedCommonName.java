 ...
 */
@JsonPropertyOrder({
  MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName.JSON_PROPERTY_MSG_VPN_NAME,
  MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName.JSON_PROPERTY_REST_CONSUMER_NAME,
  MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName.JSON_PROPERTY_REST_DELIVERY_POINT_NAME,
  MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName.JSON_PROPERTY_TLS_TRUSTED_COMMON_NAME
})
...
public class MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName {
  ...
  public static final String JSON_PROPERTY_TLS_TRUSTED_COMMON_NAME = "tlsTrustedCommonName";
  private String tlsTrustedCommonName;

  public MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName() {
  }
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TLS_TRUSTED_COMMON_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
