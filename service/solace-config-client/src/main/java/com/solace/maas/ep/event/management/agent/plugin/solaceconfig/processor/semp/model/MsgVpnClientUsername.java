 ...
 */
@JsonPropertyOrder({
  MsgVpnClientUsername.JSON_PROPERTY_ACL_PROFILE_NAME,
  MsgVpnClientUsername.JSON_PROPERTY_CLIENT_PROFILE_NAME,
  MsgVpnClientUsername.JSON_PROPERTY_CLIENT_USERNAME,
  MsgVpnClientUsername.JSON_PROPERTY_ENABLED,
  MsgVpnClientUsername.JSON_PROPERTY_GUARANTEED_ENDPOINT_PERMISSION_OVERRIDE_ENABLED,
  MsgVpnClientUsername.JSON_PROPERTY_MSG_VPN_NAME,
  MsgVpnClientUsername.JSON_PROPERTY_PASSWORD,
  MsgVpnClientUsername.JSON_PROPERTY_SUBSCRIPTION_MANAGER_ENABLED
})
...
public class MsgVpnClientUsername {
  ...
  public static final String JSON_PROPERTY_GUARANTEED_ENDPOINT_PERMISSION_OVERRIDE_ENABLED = "guaranteedEndpointPermissionOverrideEnabled";
  private Boolean guaranteedEndpointPermissionOverrideEnabled;
  ...
  public static final String JSON_PROPERTY_SUBSCRIPTION_MANAGER_ENABLED = "subscriptionManagerEnabled";
  private Boolean subscriptionManagerEnabled;

  public MsgVpnClientUsername() {
  }
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_GUARANTEED_ENDPOINT_PERMISSION_OVERRIDE_ENABLED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_SUBSCRIPTION_MANAGER_ENABLED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
