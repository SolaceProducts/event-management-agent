 ...
 */
@JsonPropertyOrder({
  DmrClusterLinkTlsTrustedCommonName.JSON_PROPERTY_DMR_CLUSTER_NAME,
  DmrClusterLinkTlsTrustedCommonName.JSON_PROPERTY_REMOTE_NODE_NAME,
  DmrClusterLinkTlsTrustedCommonName.JSON_PROPERTY_TLS_TRUSTED_COMMON_NAME
})
