 ...
 */
@JsonPropertyOrder({
  MsgVpnReplayLog.JSON_PROPERTY_EGRESS_ENABLED,
  MsgVpnReplayLog.JSON_PROPERTY_INGRESS_ENABLED,
  MsgVpnReplayLog.JSON_PROPERTY_MAX_SPOOL_USAGE,
  MsgVpnReplayLog.JSON_PROPERTY_MSG_VPN_NAME,
...
public class MsgVpnReplayLog {
  ...
  public static final String JSON_PROPERTY_TOPIC_FILTER_ENABLED = "topicFilterEnabled";
  private Boolean topicFilterEnabled;

  public MsgVpnReplayLog() {
  }
  ...
  **/
  ...
  public MsgVpnReplayLog topicFilterEnabled(Boolean topicFilterEnabled) {
    
    this.topicFilterEnabled = topicFilterEnabled;
    return this;
  }
   ...
   * @return topicFilterEnabled
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TOPIC_FILTER_ENABLED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getTopicFilterEnabled() {
    return topicFilterEnabled;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TOPIC_FILTER_ENABLED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTopicFilterEnabled(Boolean topicFilterEnabled) {
    this.topicFilterEnabled = topicFilterEnabled;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.egressEnabled, msgVpnReplayLog.egressEnabled) &&
        ...
        Objects.equals(this.topicFilterEnabled, msgVpnReplayLog.topicFilterEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(egressEnabled, ingressEnabled, maxSpoolUsage, msgVpnName, replayLogName, topicFilterEnabled);
  }
