 ...
 */
@JsonPropertyOrder({
  SystemInformation.JSON_PROPERTY_PLATFORM,
  SystemInformation.JSON_PROPERTY_SEMP_VERSION
})
...
public class SystemInformation {
  ...
  public static final String JSON_PROPERTY_SEMP_VERSION = "sempVersion";
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_SEMP_VERSION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
