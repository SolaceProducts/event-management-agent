 ...
 */
@JsonPropertyOrder({
  SempPaging.JSON_PROPERTY_CURSOR_QUERY,
  SempPaging.JSON_PROPERTY_NEXT_PAGE_URI
})
...
public class SempPaging {
  public static final String JSON_PROPERTY_CURSOR_QUERY = "cursorQuery";
  private String cursorQuery;

  public static final String JSON_PROPERTY_NEXT_PAGE_URI = "nextPageUri";
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_CURSOR_QUERY)
