 ...
 */
@JsonPropertyOrder({
  MsgVpnDmrBridge.JSON_PROPERTY_MSG_VPN_NAME,
  MsgVpnDmrBridge.JSON_PROPERTY_REMOTE_MSG_VPN_NAME,
  MsgVpnDmrBridge.JSON_PROPERTY_REMOTE_NODE_NAME
})
