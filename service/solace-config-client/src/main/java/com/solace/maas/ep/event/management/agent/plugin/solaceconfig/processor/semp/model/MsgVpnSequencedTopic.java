...
public class MsgVpnSequencedTopic {
  ...
  public static final String JSON_PROPERTY_SEQUENCED_TOPIC = "sequencedTopic";
  private String sequencedTopic;

  public MsgVpnSequencedTopic() {
  }
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_SEQUENCED_TOPIC)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
