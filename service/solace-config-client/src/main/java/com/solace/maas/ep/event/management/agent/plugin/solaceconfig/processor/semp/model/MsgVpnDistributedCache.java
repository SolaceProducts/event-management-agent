 ...
 */
@JsonPropertyOrder({
  MsgVpnDistributedCache.JSON_PROPERTY_CACHE_NAME,
  MsgVpnDistributedCache.JSON_PROPERTY_CACHE_VIRTUAL_ROUTER,
  MsgVpnDistributedCache.JSON_PROPERTY_ENABLED,
  MsgVpnDistributedCache.JSON_PROPERTY_HEARTBEAT,
  MsgVpnDistributedCache.JSON_PROPERTY_MSG_VPN_NAME,
  MsgVpnDistributedCache.JSON_PROPERTY_SCHEDULED_DELETE_MSG_DAY_LIST,
  MsgVpnDistributedCache.JSON_PROPERTY_SCHEDULED_DELETE_MSG_TIME_LIST
})
...
public class MsgVpnDistributedCache {
  ...
  /**
   * The virtual router of the Distributed Cache. The default value is &#x60;\&quot;auto\&quot;&#x60;. The allowed values and their meaning are:  &lt;pre&gt; \&quot;auto\&quot; - The Distributed Cache is automatically assigned a virtual router at creation, depending on the broker&#39;s active-standby role. &lt;/pre&gt;  Available since 2.28.
   */
  public enum CacheVirtualRouterEnum {
    AUTO("auto");

    private String value;

    CacheVirtualRouterEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static CacheVirtualRouterEnum fromValue(String value) {
      for (CacheVirtualRouterEnum b : CacheVirtualRouterEnum.values()) {
  ...
  public static final String JSON_PROPERTY_CACHE_VIRTUAL_ROUTER = "cacheVirtualRouter";
  private CacheVirtualRouterEnum cacheVirtualRouter;
  ...
  public static final String JSON_PROPERTY_SCHEDULED_DELETE_MSG_DAY_LIST = "scheduledDeleteMsgDayList";
  private String scheduledDeleteMsgDayList;

  public static final String JSON_PROPERTY_SCHEDULED_DELETE_MSG_TIME_LIST = "scheduledDeleteMsgTimeList";
  private String scheduledDeleteMsgTimeList;

  public MsgVpnDistributedCache() {
  }
  ...
  **/
  ...
  public MsgVpnDistributedCache cacheVirtualRouter(CacheVirtualRouterEnum cacheVirtualRouter) {
    
    this.cacheVirtualRouter = cacheVirtualRouter;
    return this;
  }

   /**
   * The virtual router of the Distributed Cache. The default value is &#x60;\&quot;auto\&quot;&#x60;. The allowed values and their meaning are:  &lt;pre&gt; \&quot;auto\&quot; - The Distributed Cache is automatically assigned a virtual router at creation, depending on the broker&#39;s active-standby role. &lt;/pre&gt;  Available since 2.28.
   * @return cacheVirtualRouter
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CACHE_VIRTUAL_ROUTER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public CacheVirtualRouterEnum getCacheVirtualRouter() {
    return cacheVirtualRouter;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CACHE_VIRTUAL_ROUTER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCacheVirtualRouter(CacheVirtualRouterEnum cacheVirtualRouter) {
    this.cacheVirtualRouter = cacheVirtualRouter;
  }
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_SCHEDULED_DELETE_MSG_DAY_LIST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_SCHEDULED_DELETE_MSG_TIME_LIST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cacheName, msgVpnDistributedCache.cacheName) &&
        Objects.equals(this.cacheVirtualRouter, msgVpnDistributedCache.cacheVirtualRouter) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cacheName, cacheVirtualRouter, enabled, heartbeat, msgVpnName, scheduledDeleteMsgDayList, scheduledDeleteMsgTimeList);
  }
