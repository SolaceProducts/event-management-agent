 ...
 */
@JsonPropertyOrder({
  MsgVpnDistributedCacheClusterInstance.JSON_PROPERTY_AUTO_START_ENABLED,
  MsgVpnDistributedCacheClusterInstance.JSON_PROPERTY_CACHE_NAME,
  MsgVpnDistributedCacheClusterInstance.JSON_PROPERTY_CLUSTER_NAME,
  MsgVpnDistributedCacheClusterInstance.JSON_PROPERTY_ENABLED,
  MsgVpnDistributedCacheClusterInstance.JSON_PROPERTY_INSTANCE_NAME,
  MsgVpnDistributedCacheClusterInstance.JSON_PROPERTY_MSG_VPN_NAME,
  MsgVpnDistributedCacheClusterInstance.JSON_PROPERTY_STOP_ON_LOST_MSG_ENABLED
})
...
public class MsgVpnDistributedCacheClusterInstance {
  public static final String JSON_PROPERTY_AUTO_START_ENABLED = "autoStartEnabled";
  ...
  public static final String JSON_PROPERTY_STOP_ON_LOST_MSG_ENABLED = "stopOnLostMsgEnabled";
  private Boolean stopOnLostMsgEnabled;
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_STOP_ON_LOST_MSG_ENABLED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
