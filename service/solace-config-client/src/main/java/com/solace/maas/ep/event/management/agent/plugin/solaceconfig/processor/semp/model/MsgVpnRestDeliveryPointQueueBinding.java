 ...
 */
@JsonPropertyOrder({
  MsgVpnRestDeliveryPointQueueBinding.JSON_PROPERTY_GATEWAY_REPLACE_TARGET_AUTHORITY_ENABLED,
  MsgVpnRestDeliveryPointQueueBinding.JSON_PROPERTY_MSG_VPN_NAME,
  MsgVpnRestDeliveryPointQueueBinding.JSON_PROPERTY_POST_REQUEST_TARGET,
  MsgVpnRestDeliveryPointQueueBinding.JSON_PROPERTY_QUEUE_BINDING_NAME,
  MsgVpnRestDeliveryPointQueueBinding.JSON_PROPERTY_REQUEST_TARGET_EVALUATION,
  MsgVpnRestDeliveryPointQueueBinding.JSON_PROPERTY_REST_DELIVERY_POINT_NAME
})
...
public class MsgVpnRestDeliveryPointQueueBinding {
  public static final String JSON_PROPERTY_GATEWAY_REPLACE_TARGET_AUTHORITY_ENABLED = "gatewayReplaceTargetAuthorityEnabled";
  private Boolean gatewayReplaceTargetAuthorityEnabled;

  public static final String JSON_PROPERTY_MSG_VPN_NAME = "msgVpnName";
  private String msgVpnName;

  public static final String JSON_PROPERTY_POST_REQUEST_TARGET = "postRequestTarget";
  private String postRequestTarget;

  public static final String JSON_PROPERTY_QUEUE_BINDING_NAME = "queueBindingName";
   ...
   */
  public enum RequestTargetEvaluationEnum {
    NONE("none"),
    ...
    RequestTargetEvaluationEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static RequestTargetEvaluationEnum fromValue(String value) {
      for (RequestTargetEvaluationEnum b : RequestTargetEvaluationEnum.values()) {
  ...
  public static final String JSON_PROPERTY_REQUEST_TARGET_EVALUATION = "requestTargetEvaluation";
  private RequestTargetEvaluationEnum requestTargetEvaluation;
  ...
  public MsgVpnRestDeliveryPointQueueBinding() {
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_GATEWAY_REPLACE_TARGET_AUTHORITY_ENABLED)
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_POST_REQUEST_TARGET)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_QUEUE_BINDING_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public MsgVpnRestDeliveryPointQueueBinding requestTargetEvaluation(RequestTargetEvaluationEnum requestTargetEvaluation) {
    
    this.requestTargetEvaluation = requestTargetEvaluation;
    return this;
  }

   /**
   * The type of evaluation to perform on the request target. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is &#x60;\&quot;none\&quot;&#x60;. The allowed values and their meaning are:  &lt;pre&gt; \&quot;none\&quot; - Do not evaluate substitution expressions on the request target. \&quot;substitution-expressions\&quot; - Evaluate substitution expressions on the request target. &lt;/pre&gt;  Available since 2.23.
   * @return requestTargetEvaluation
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_REQUEST_TARGET_EVALUATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public RequestTargetEvaluationEnum getRequestTargetEvaluation() {
    return requestTargetEvaluation;
  }
  ...
  @JsonProperty(JSON_PROPERTY_REQUEST_TARGET_EVALUATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRequestTargetEvaluation(RequestTargetEvaluationEnum requestTargetEvaluation) {
    this.requestTargetEvaluation = requestTargetEvaluation;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gatewayReplaceTargetAuthorityEnabled, msgVpnRestDeliveryPointQueueBinding.gatewayReplaceTargetAuthorityEnabled) &&
        ...
        Objects.equals(this.requestTargetEvaluation, msgVpnRestDeliveryPointQueueBinding.requestTargetEvaluation) &&
        Objects.equals(this.restDeliveryPointName, msgVpnRestDeliveryPointQueueBinding.restDeliveryPointName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gatewayReplaceTargetAuthorityEnabled, msgVpnName, postRequestTarget, queueBindingName, requestTargetEvaluation, restDeliveryPointName);
  }
