 ...
 */
@JsonPropertyOrder({
  ClientCertAuthority.JSON_PROPERTY_CERT_AUTHORITY_NAME,
  ClientCertAuthority.JSON_PROPERTY_CERT_CONTENT,
  ClientCertAuthority.JSON_PROPERTY_CRL_DAY_LIST,
  ClientCertAuthority.JSON_PROPERTY_CRL_TIME_LIST,
  ClientCertAuthority.JSON_PROPERTY_CRL_URL,
  ClientCertAuthority.JSON_PROPERTY_OCSP_NON_RESPONDER_CERT_ENABLED,
  ClientCertAuthority.JSON_PROPERTY_OCSP_OVERRIDE_URL,
  ClientCertAuthority.JSON_PROPERTY_OCSP_TIMEOUT,
  ClientCertAuthority.JSON_PROPERTY_REVOCATION_CHECK_ENABLED
})
...
public class ClientCertAuthority {
  public static final String JSON_PROPERTY_CERT_AUTHORITY_NAME = "certAuthorityName";
  private String certAuthorityName;

  public static final String JSON_PROPERTY_CERT_CONTENT = "certContent";
  private String certContent;

  public static final String JSON_PROPERTY_CRL_DAY_LIST = "crlDayList";
  private String crlDayList;

  public static final String JSON_PROPERTY_CRL_TIME_LIST = "crlTimeList";
  private String crlTimeList;

  public static final String JSON_PROPERTY_CRL_URL = "crlUrl";
  private String crlUrl;

  public static final String JSON_PROPERTY_OCSP_NON_RESPONDER_CERT_ENABLED = "ocspNonResponderCertEnabled";
  private Boolean ocspNonResponderCertEnabled;

  public static final String JSON_PROPERTY_OCSP_OVERRIDE_URL = "ocspOverrideUrl";
  private String ocspOverrideUrl;

  public static final String JSON_PROPERTY_OCSP_TIMEOUT = "ocspTimeout";
  private Long ocspTimeout;

  public static final String JSON_PROPERTY_REVOCATION_CHECK_ENABLED = "revocationCheckEnabled";
  private Boolean revocationCheckEnabled;

  public ClientCertAuthority() {
  }

  public ClientCertAuthority certAuthorityName(String certAuthorityName) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_CERT_AUTHORITY_NAME)
  ...
  public ClientCertAuthority certContent(String certContent) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CERT_CONTENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public ClientCertAuthority crlDayList(String crlDayList) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CRL_DAY_LIST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public ClientCertAuthority crlTimeList(String crlTimeList) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CRL_TIME_LIST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public ClientCertAuthority crlUrl(String crlUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CRL_URL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public ClientCertAuthority ocspNonResponderCertEnabled(Boolean ocspNonResponderCertEnabled) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_OCSP_NON_RESPONDER_CERT_ENABLED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getOcspNonResponderCertEnabled() {
    return ocspNonResponderCertEnabled;
  }
  ...
  public ClientCertAuthority ocspOverrideUrl(String ocspOverrideUrl) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_OCSP_OVERRIDE_URL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public ClientCertAuthority ocspTimeout(Long ocspTimeout) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_OCSP_TIMEOUT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public ClientCertAuthority revocationCheckEnabled(Boolean revocationCheckEnabled) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_REVOCATION_CHECK_ENABLED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getRevocationCheckEnabled() {
    return revocationCheckEnabled;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClientCertAuthority clientCertAuthority = (ClientCertAuthority) o;
    return Objects.equals(this.certAuthorityName, clientCertAuthority.certAuthorityName) &&
        Objects.equals(this.certContent, clientCertAuthority.certContent) &&
        Objects.equals(this.crlDayList, clientCertAuthority.crlDayList) &&
        Objects.equals(this.crlTimeList, clientCertAuthority.crlTimeList) &&
        Objects.equals(this.crlUrl, clientCertAuthority.crlUrl) &&
        Objects.equals(this.ocspNonResponderCertEnabled, clientCertAuthority.ocspNonResponderCertEnabled) &&
        Objects.equals(this.ocspOverrideUrl, clientCertAuthority.ocspOverrideUrl) &&
        Objects.equals(this.ocspTimeout, clientCertAuthority.ocspTimeout) &&
        Objects.equals(this.revocationCheckEnabled, clientCertAuthority.revocationCheckEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClientCertAuthority {\n");
