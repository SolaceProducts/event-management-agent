...
resource "solacebroker_msg_vpn_queue" "fh71c08said-Consumer2" {
  provider                                      = solacebroker.fh71c08said
...
resource "solacebroker_msg_vpn_queue_subscription" "fh71c08said-Consumer2_a_b_c__" {
  provider           = solacebroker.fh71c08said
  msg_vpn_name       = solacebroker_msg_vpn_queue.fh71c08said-Consumer2.msg_vpn_name
  queue_name         = solacebroker_msg_vpn_queue.fh71c08said-Consumer2.queue_name
