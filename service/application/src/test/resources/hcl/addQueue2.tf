...
resource "solacebroker_msg_vpn_queue" "fh71c08saie-Consumer2" {
  provider                                      = solacebroker.fh71c08saie
  msg_vpn_name                                  = data.solacebroker_msg_vpn.fh71c08saie.msg_vpn_name
  owner                                         = "discovery"
  max_ttl                                       = 0
...
resource "solacebroker_msg_vpn_queue_subscription" "fh71c08saie-Consumer2_a_b_c__" {
  provider           = solacebroker.fh71c08saie
  msg_vpn_name       = solacebroker_msg_vpn_queue.fh71c08saie-Consumer2.msg_vpn_name
  queue_name         = solacebroker_msg_vpn_queue.fh71c08saie-Consumer2.queue_name
