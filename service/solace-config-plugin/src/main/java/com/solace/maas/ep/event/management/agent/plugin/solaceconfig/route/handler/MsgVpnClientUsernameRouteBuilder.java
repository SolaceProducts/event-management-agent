...
@Component
public class MsgVpnClientUsernameRouteBuilder extends DataPublisherRouteBuilder {
    /**
     * @param processor The Processor handling the Data Collection for a Scan.
     */
    @Autowired
    public MsgVpnClientUsernameRouteBuilder(AclProfileTaskProcessor processor, RouteManager routeManager,
