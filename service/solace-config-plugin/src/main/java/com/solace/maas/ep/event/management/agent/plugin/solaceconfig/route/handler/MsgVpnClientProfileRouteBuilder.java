...
import com.solace.maas.ep.event.management.agent.plugin.solaceconfig.processor.ClientProfileTaskProcessor;
...
@Component
public class MsgVpnClientProfileRouteBuilder extends ConfigExecutorRouteBuilder {
    /**
     * @param processor The Processor handling the Data Collection for a Scan.
     */
    @Autowired
    public MsgVpnClientProfileRouteBuilder(ClientProfileTaskProcessor processor, RouteManager routeManager,
                                           MDCProcessor mdcProcessor, EmptyScanEntityProcessor emptyScanEntityProcessor) {
        super(processor, SolaceSEMPv2RouteId.MsgVpnClientProfile.label, SolaceSEMPv2RouteType.MsgVpnClientProfile.label,
