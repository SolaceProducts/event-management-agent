package com.solace.maas.ep.runtime.agent.plugin.processor.kafka.consumer;

import com.solace.maas.ep.runtime.agent.plugin.processor.base.ResultProcessorImpl;
import com.solace.maas.ep.runtime.agent.plugin.processor.kafka.event.consumer.ConsumerEvent;
import com.solace.maas.ep.runtime.agent.plugin.processor.kafka.event.consumer.ConsumerTopicPartitionEvent;
import com.solace.maas.ep.runtime.agent.plugin.processor.kafka.event.general.KafkaAclEvent;
import com.solace.maas.ep.runtime.agent.plugin.processor.kafka.event.consumer.KafkaConsumerGroupConfigurationEvent;
import com.solace.maas.ep.runtime.agent.plugin.processor.kafka.event.consumer.KafkaConsumerGroupEvent;
