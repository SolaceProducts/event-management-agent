...
import com.solace.maas.ep.runtime.agent.plugin.kafka.processor.feature.KafkaFeaturesProcessor;
...
public class KafkaFeatureDataPublisherRouteBuilder extends DataPublisherRouteBuilder {
    @Autowired
    public KafkaFeatureDataPublisherRouteBuilder(KafkaFeaturesProcessor processor, RouteManager routeManager, MDCProcessor mdcProcessor) {
        super(processor, KafkaRouteId.KAFKA_FEATURES.label, KafkaRouteType.KAFKA_FEATURES.label, routeManager, mdcProcessor);
    }
}
