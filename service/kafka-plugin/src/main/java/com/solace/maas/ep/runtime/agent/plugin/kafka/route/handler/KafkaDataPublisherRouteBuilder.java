...
public class KafkaDataPublisherRouteBuilder extends DataPublisherRouteBuilder {
     ...
     */
    @Autowired
    public KafkaDataPublisherRouteBuilder(KafkaTopicListingProcessor processor, RouteManager routeManager, MDCProcessor mdcProcessor) {
        super(processor, KafkaRouteId.KAFKA_TOPIC_LISTING.label, KafkaRouteType.KAFKA_TOPIC_LISTING.label, routeManager, mdcProcessor);
    }
}
